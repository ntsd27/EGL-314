...
malabel = tk.Button(main, text= 'Face Light', command= point,width=10, height=2,font=("Arial", 16))
...
combinlabel = tk.Label(main, text= 'Combined',font=("Arial", 16))
combinlabel.grid(row=0, column= 7)

duibutton = tk.Button(main, text= 'Correct', command= combined,width=10, height=2,font=("Arial", 16))
duibutton.grid(row=1, column= 7,pady= 10,padx = 10)

cuobutton = tk.Button(main, text= 'Wrong', command= combinedwrong,width=10, height=2,font=("Arial", 16))
cuobutton.grid(row=2, column= 7,pady= 10,padx = 10)
